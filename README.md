...
![Location](https://img.shields.io/badge/Medellín,_Colombia-0A66C2?style=flat-square&logo=googlemaps&logoColor=white)
![Focus](https://img.shields.io/badge/Cloud_·_Data_·_AI_Agents-1a1a2e?style=flat-square)
![Status](https://img.shields.io/badge/Open_to_Opportunities-2ea44f?style=flat-square)

---

## About Me

My background in mechanical engineering and automotive systems gave me something most tech profiles lack: a systems-first mindset, precision under constraints, and the discipline to document how things work. I'm now applying that foundation to a focused transition into Cloud Architecture, Data Engineering, and AI-driven automation.

I work hands-on — building labs, deploying infrastructure, structuring repositories, and learning in public. My GitHub is an active record of that process: not polished highlights, but real technical work in progress.
...
- Google Cloud Professional certification path
- Cloud security fundamentals (IAM, compliance, network hardening)
- Data Engineering foundations — pipelines, BigQuery, structured workflows
- AI Agent architecture — LLM integration, tool-calling, autonomous workflows
- Technical English — professional communication for international environments
...
|---|---|
| Systems thinking | Translates complex infrastructure into clear, logical architecture |
| Technical documentation | Every lab, every project — structured and accessible |
| Self-directed learning | Multi-platform, hands-on, portfolio-driven approach |
| Cross-domain perspective | Engineering precision applied to cloud and data problems |
| Continuous improvement | Iterative work, structured feedback, consistent output |
...
<sub>This profile is an active portfolio — updated as I build, learn, and grow.</sub>
